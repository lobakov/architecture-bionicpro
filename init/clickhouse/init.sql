...
SETTINGS
    ...
    kafka_group_name = 'clickhouse_telemetry_consumer_v2',
...
SETTINGS
    ...
    kafka_group_name = 'clickhouse_clients_consumer_v2',
    kafka_format = 'JSONEachRow';
...
SELECT
    event_id,
    user_id,
    toDateTime(event_time / 1000000) AS event_time,
    signal_strength,
    duration
...
CREATE MATERIALIZED VIEW reports.mv_user_report TO reports.user_report_mart_cdc AS
SELECT
    t.user_id,
...
GROUP BY t.user_id, event_date, c.full_name, c.email, c.prosthesis_model;
